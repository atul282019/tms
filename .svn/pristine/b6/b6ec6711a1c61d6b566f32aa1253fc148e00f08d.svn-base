	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException{
		...
		if(login==null){	
			if(isStaticResourceFonts || isStaticResourceImg || isStaticResourceJs || isStaticResourceSass) {
				...
				rd.forward(request, response);
			}else if(requestURI.contains("/stateMaster")) {
				RequestDispatcher rd = request.getRequestDispatcher("stateMaster");
				rd.forward(request, response);
			}else if(requestURI.contains("/spacility-master-approval")) {
				RequestDispatcher rd = request.getRequestDispatcher("spacility-master-approval");
				rd.forward(request, response);
			}else if(requestURI.contains("/getSpecialityMasterApproval")) {
				RequestDispatcher rd = request.getRequestDispatcher("getSpecialityMasterApproval");
				rd.forward(request, response);
			}else if(requestURI.contains("/approveSpecialityMasterData")) {
				RequestDispatcher rd = request.getRequestDispatcher("/approveSpecialityMasterData");
				rd.forward(request, response);
			}else if(requestURI.contains("/package-master-approval")) {
				RequestDispatcher rd = request.getRequestDispatcher("package-master-approval");
				rd.forward(request, response);
			}else if(requestURI.contains("/getPackageMasterApproval")) {
				RequestDispatcher rd = request.getRequestDispatcher("getPackageMasterApproval");
				rd.forward(request, response);
			}else if(requestURI.contains("/approvePackageMasterData")) {
				RequestDispatcher rd = request.getRequestDispatcher("approvePackageMasterData");
				rd.forward(request, response);
			}else if(requestURI.contains("/hospReference")) {
				RequestDispatcher rd = request.getRequestDispatcher("/hospReference");
				rd.forward(request, response);
			}else if(requestURI.contains("/getHemMappingList")) {
				RequestDispatcher rd = request.getRequestDispatcher("/getHemMappingList");
				rd.forward(request, response);
			}else if(requestURI.contains("/getspecialityByHospitalState")) {
				RequestDispatcher rd = request.getRequestDispatcher("/getspecialityByHospitalState");
				rd.forward(request, response);
			}else if(requestURI.contains("/getprocedure-master-approval")) {
				RequestDispatcher rd = request.getRequestDispatcher("getprocedure-master-approval");
				rd.forward(request, response);
			}else if(requestURI.contains("/approveProcedureMasterData")) {
				RequestDispatcher rd = request.getRequestDispatcher("approveProcedureMasterData");
				rd.forward(request, response);
			}else if(requestURI.contains("/getprice-master-approval")) {
				RequestDispatcher rd = request.getRequestDispatcher("getprice-master-approval");
				rd.forward(request, response);
			}else if(requestURI.contains("/approvePriceMasterData")) {
				RequestDispatcher rd = request.getRequestDispatcher("approvePriceMasterData");
				rd.forward(request, response);
			}else if(requestURI.contains("/getprice-master-approval")) {
				RequestDispatcher rd = request.getRequestDispatcher("/getprice-master-approval");
				rd.forward(request, response);
			}else if(requestURI.contains("/getdocument-master-approval")) {
				RequestDispatcher rd = request.getRequestDispatcher("getdocument-master-approval");
				rd.forward(request, response);
			}else if(requestURI.contains("/approveDocumentMasterData")) {
				RequestDispatcher rd = request.getRequestDispatcher("/approveDocumentMasterData");
				rd.forward(request, response);
			}else if(requestURI.contains("/getdocumentapproval")) {
				RequestDispatcher rd = request.getRequestDispatcher("/getdocumentapproval");
				rd.forward(request, response);
			}else if(requestURI.contains("/getimplantapproval")) {
				RequestDispatcher rd = request.getRequestDispatcher("getimplantapproval");
				rd.forward(request, response);
			}else if(requestURI.contains("/getstratificationapproval")) {
				RequestDispatcher rd = request.getRequestDispatcher("getstratificationapproval");
				rd.forward(request, response);
			}
			else if(requestURI.contains("/getstatification-master-approval")) {
				RequestDispatcher rd = request.getRequestDispatcher("getstatification-master-approval");
				rd.forward(request, response);
			}
			else if(requestURI.contains("/approveStratificationMasterData")) {
				RequestDispatcher rd = request.getRequestDispatcher("approveStratificationMasterData");
				rd.forward(request, response);
			}else if(requestURI.contains("/getimplant-master-approval")) {
				RequestDispatcher rd = request.getRequestDispatcher("getimplant-master-approval");
				rd.forward(request, response);
			}else if(requestURI.contains("/approveImplantMasterData")) {
				RequestDispatcher rd = request.getRequestDispatcher("approveImplantMasterData");
				rd.forward(request, response);
			}else if(requestURI.contains("/statusChangeHospSpecMapping")) {
				RequestDispatcher rd = request.getRequestDispatcher("statusChangeHospSpecMapping");
				rd.forward(request, response);
			}else if(requestURI.contains("/savehospitalSpeciality")) {
				RequestDispatcher rd = request.getRequestDispatcher("savehospitalSpeciality");
				rd.forward(request, response);
			}else if(requestURI.contains("/getinvestigationapproval")) {
				RequestDispatcher rd = request.getRequestDispatcher("getinvestigationapproval");
				rd.forward(request, response);
			}else if(requestURI.contains("/searchIcdData")) {
				RequestDispatcher rd = request.getRequestDispatcher("searchIcdData");
				rd.forward(request, response);
			}else if(requestURI.contains("/getinvestigation-master-approval")) {
				RequestDispatcher rd = request.getRequestDispatcher("getinvestigation-master-approval");
				rd.forward(request, response);
			}else if(requestURI.contains("/approveInvestigationMasterData")) {
				RequestDispatcher rd = request.getRequestDispatcher("approveInvestigationMasterData");
				rd.forward(request, response);
			}else if(requestURI.contains("/imagecontetread")) {
				RequestDispatcher rd = request.getRequestDispatcher("imagecontetread");
				rd.forward(request, response);
			}else if(requestURI.contains("/readImageContent")) {
				RequestDispatcher rd = request.getRequestDispatcher("readImageContent");
				rd.forward(request, response);
			}else{
				RequestDispatcher rd = request.getRequestDispatcher("index");
				rd.forward(request, response);
