...
public class PatientRegistrationServiceImpl implements PatientRegistrationService{
	...
	public String saveRegisterPatientData(ResponseGoldenAPI reg) {
		Gson gson = new Gson();
		return CommonUtility.userRequest(null,gson.toJson(reg), applicationConstantConfig.SAVE_REGISTER_PATIENT_SERVICE);
	}
	...
	@Override
	public String getRegisteredPatientData(String token,String hospitalId, String loginUserId) {
			return CommonUtility.userRequest(token,null, applicationConstantConfig.GET_ALL_REGISTERED_PATIENT_DATA+"?hospitalId="+hospitalId+"&loginUserId="+loginUserId);
		}

	@Override
	public String getTodayAndTotalPatient(String token) {
		// TODO Auto-generated method stub
		return CommonUtility.userRequest(token,null, applicationConstantConfig.GET_PATIENT_DATA_COUNT_TOTAL_TODAY);
	}
