...
public class UserAuthenticationService {
	...
	public String getCurrentHosp(String token,String loginid, String stateCode) {
		return CommonUtility.userRequest(token,null, applicationConstantConfig.GET_CURRENT_USER_HOSPITAL_DATA+"?uid="+loginid+"&scode="+stateCode);
	}
